Expands the correlation function of the n-body system using a [[Multipole Expansion|multipole expansion]] in order to treat sources that are close together as one. 
